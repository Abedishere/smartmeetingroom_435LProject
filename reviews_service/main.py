"""
FastAPI application entrypoint for reviews service.
"""
...
from reviews_service.routes import router


# Initialize rate limiter
limiter = Limiter(key_func=get_remote_address, default_limits=["200 per day", "50 per hour"])

app = FastAPI(title="Smart Meeting Room - Reviews Service")
...
if __name__ == "__main__":
    ...
    uvicorn.run("reviews_service.main:app", host="0.0.0.0", port=5004, reload=True)
